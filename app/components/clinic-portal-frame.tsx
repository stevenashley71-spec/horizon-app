...
import { ClinicPortalNav } from '@/app/(clinic)/portal-nav'
...
export async function ClinicPortalFrame({
  children,
  clinicName,
  clinicLogoPath,
}: Readonly<{
  ...
  const clinicLogoUrl = await getClinicLogoUrl(clinicLogoPath)
  const clinicInitials = getClinicInitials(clinicName)
